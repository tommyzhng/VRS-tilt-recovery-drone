...
figure;
subplot(3,1,1);
plot(Vz_Vh_Sweep, Tilt_Ct_2000, '-o', 'DisplayName', '45° Tilt');
hold on;
plot(Vz_Vh_Sweep, NoTilt_Ct_2000, '-x', 'DisplayName', '0° Tilt');
title('Norm. Thrust Coefficient Comparison @ 2000 RPM');
xlabel('Vz/Vi_0');
ylabel('Ct/Ct_0');
...
% Plot for RPM 6000
subplot(3,1,2);
plot(Vz_Vh_Sweep, Tilt_Ct_6000, '-o', 'DisplayName', '45° Tilt');
hold on;
plot(Vz_Vh_Sweep, NoTilt_Ct_6000, '-x', 'DisplayName', '0° Tilt');
title('Norm. Thrust Coefficient Comparison @ 6000 RPM');
xlabel('Vz/Vi_0');
ylabel('Ct/Ct_0');
legend('Location', 'best');
grid on;
...
% Plot for RPM 10000
subplot(3,1,3);
plot(Vz_Vh_Sweep, Tilt_Ct_10000, '-o', 'DisplayName', '45° Tilt');
hold on;
plot(Vz_Vh_Sweep, NoTilt_Ct_10000, '-x', 'DisplayName', '0° Tilt');
title('Norm. Thrust Coefficient Comparison @ 10000 RPM');
xlabel('Vz/Vi_0');
ylabel('Ct/Ct_0');
legend('Location', 'best');
grid on;
